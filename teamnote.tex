...
\rhead{Sogang University - goraani}
\fancyfoot{}
...
\title{Team Note of goraani}
\author{djs100201, dong\_gas, wbcho0504}
...
\begin{minted}{cpp}
// 정렬 기준을 HilOrd로..
// 단, HilOrd로 하면 구간 넓히고 줄일 때, add/del 연산 순서가 중요하다.
// add -> del 순서를 지켜주자.
